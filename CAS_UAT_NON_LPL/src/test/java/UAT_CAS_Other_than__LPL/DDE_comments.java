...
public class DDE_comments extends BrowserSetup {
		...
		public void DDE(String sLogin_id,String sPassword,String sArea,String First_Name,String Last_Name,String Father_Name,String Product,
				...
				String loan_Tennure,String first_EMI_Month,String first_EMI_Year) throws Throwable {
		...
		//	driver.switchTo().window(repaymentwindow.get(0));
			...
			WebElement splitupdate = driver.findElement(By.name("btnUpdate"));

			wait.until(ExpectedConditions.visibilityOf(splitupdate));
	...
	/*		WebElement checkone = driver.findElement(By.id("jqg_gridtableOfDocumets_1"));
		...
		/*	WebElement confirmbtn = driver.findElement(By.xpath("//html/body/div[5]/div[3]/div[1]/button[1]/span[1]"));
			...
			WebElement confirmexit = driver.findElement(By.xpath("//html/body/div[5]/div[3]/div[1]/button[1]/span[1]"));
			
			wait.until(ExpectedConditions.visibilityOf(confirmexit));
		...
		/*	WebElement exit_dms = driver.findElement(By.id("exit"));
			
			wait.until(ExpectedConditions.visibilityOf(exit_dms));*/
			
		//	Thread.sleep(200);
			
		//	exit_dms.sendKeys(Keys.ENTER);	
